...
pub struct Federation {
    ...
    pub biology: Arc<RwLock<crate::biology::SystemBiology>>,
}
...
impl Federation {
    pub(crate) fn from_parts(
        ...
        let nats = Arc::new(crate::nats_client::NatsPublisher::new(crate::nats_client::NatsClientConfig::default()));
        Self {
            persistence,
            config,
            visionary,
            ...
            biology: Arc::new(RwLock::new(crate::biology::SystemBiology::new())),
        }
    }
}
...
impl Federation {
    ...
    async fn odin_decompose_intent(&self) {
        ...
        let sab_dir = crate::workspace::WorkspacePaths::discover().sabs();
                ...
                tokio::select! {
                    ...
                    _ = tokio::time::sleep(std::time::Duration::from_secs(10)) => {
                        ...
                        for task in triggered_tasks {
                            ...
                            let _ = nc.publish("system/intent/submit", &payload_str);
                        }
                    }
                }
            }
