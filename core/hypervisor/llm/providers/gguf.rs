...
impl GGUFProvider {
    ...
    pub fn default_qwen_path() -> PathBuf {
        ...
        let locations: Vec<PathBuf> = vec![
            ...
            ws.sovereign_model("ariel"),
            ws.sovereign_model("wen"),
            // Foundation model fallback
            ws.models().join("foundation_v1.gguf"),
            // Legacy/abliterated variants
            ws.models().join("qwen2.5-1.5b-instruct-abliterated.gguf"),
            ws.models().join("qwen2.5-1.5b.gguf"),
