...
pub mod ebus_event;
pub mod marionette;
pub mod marionette_bridge;
pub mod wasm_memory;
pub use marionette::MarionetteAction;
pub use marionette_bridge::MarionetteBridge;
...
impl WasmEbusBridge {
    ...
    pub async fn invoke_wasm_export(&self, export_name: &str, args: &[u32]) -> Result<u32, String> {
