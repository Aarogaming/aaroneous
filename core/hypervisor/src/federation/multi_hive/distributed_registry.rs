...
pub struct DistributedSpecialistRegistry {
    ...
    pub specialists: HashMap<(crate::federation::specialist::SpecialistId, String), RemoteSpecialist>,
...
impl DistributedSpecialistRegistry {
    ...
    pub fn register_node(&mut self, node: crate::federation::multi_hive::HiveNode) -> Result<(), String> {
        for i in 0..6 {
            ...
            let remote = RemoteSpecialist::new(
                specialist_id,
                node.node_id.clone(),
                node.address.clone(),
            );
    ...
    pub fn update_availability(&mut self, specialist_id: crate::federation::specialist::SpecialistId, hive_node_id: &str, available: bool) {
    ...
    pub fn stats(&self) -> RegistryStats {
        ...
        RegistryStats {
            ...
            total_model_size_mb: self
                .specialists
                .values()
                .map(|s| s.model_size_mb)
                .sum(),
        }
    }
}
...
mod tests {
    ...
    fn test_remote_specialist_creation() {
        ...
        assert_eq!(specialist.specialist_id, crate::federation::specialist::SpecialistId::Visionary);
    ...
    fn test_registry_find_specialist() {
        ...
        let specialists = registry.find_specialist(crate::federation::specialist::SpecialistId::Visionary);
