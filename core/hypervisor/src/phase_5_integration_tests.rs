...
mod phase_5_biological_integration_tests {
    ...
    fn test_multi_specialist_token_management() {
        ...
        assert_eq!(bio.specialist_metabolism["enzyme_runner"].execution_count, 1);
        assert_eq!(bio.specialist_metabolism["learning_loop"].execution_count, 1);
        assert_eq!(bio.specialist_metabolism["network_executor"].execution_count, 1);
    }
