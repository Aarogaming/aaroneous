...
mod end_to_end_tests {
    ...
    fn test_task_routing_end_to_end() {
        ...
        let test_cases = vec![
            ...
            (
                "cpu_intensive",
                crate::task_routing::ExecutionRoute::CpuIntensive,
            ),
            (
                "learning_task",
                crate::task_routing::ExecutionRoute::Learning,
            ),
        ];
    ...
    fn test_specialist_memory_consultation() {
        ...
        // Create memory store
        let store =
            crate::specialist_memory::SpecialistMemoryStore::new("test_specialist".to_string());
    ...
    fn test_dopamine_learning_workflow() {
        ...
        let mut learning_loop =
            crate::unified_learning::UnifiedLearningLoop::new(config, 2, specialist_ids);
    ...
    fn test_complete_feedback_loop() {
        ...
        let mut learning_loop =
            crate::unified_learning::UnifiedLearningLoop::new(config, 1, specialist_ids);
    ...
    fn test_state_consistency_multiple_cycles() {
        ...
        for cycle in 0..20 {
            ...
            let _result =
                learning_loop.learn_from_dopamine(&task_features, specialist, reward, 0.8);
