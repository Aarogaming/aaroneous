...
/// Central workspace path resolver for Aaroneous.
///
...
impl WorkspacePaths {
    ...
    pub fn dna_bank(&self) -> PathBuf {
        self.root.join("dna_bank")
    }
    ...
    pub fn sovereign_memory(&self, sovereign: &str) -> PathBuf {
        self.data().join(format!("{}_memory.json", sovereign.to_lowercase()))
    }
    ...
    pub fn sovereign_lora_adapter(&self, sovereign: &str) -> PathBuf {
        self.models().join(format!("{}-lora-adapter.bin", sovereign.to_lowercase()))
    }

    pub fn sovereign_distilled(&self, sovereign: &str) -> PathBuf {
        self.models().join(format!("{}-distilled.gguf", sovereign.to_lowercase()))
    }

    pub fn sovereign_training_data(&self, sovereign: &str) -> PathBuf {
        self.training_data().join(format!("{}-training.jsonl", sovereign.to_lowercase()))
    }
