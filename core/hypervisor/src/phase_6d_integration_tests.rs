...
mod phase_6d_integration_tests {
    ...
    impl SubRegistry for IntegrationMockRegistry {
        ...
        fn query_entity(&self, id: &str) -> Option<EntityInfo> {
            self.state.lock().unwrap().query_history.push(id.to_string());
    ...
    fn test_phase_6d_full_lifecycle() {
        ...
        // Add registries
        master.add_registry(Box::new(IntegrationMockRegistry::new(RegistryType::Unified)));
        master.add_registry(Box::new(IntegrationMockRegistry::new(RegistryType::HoxCapability)));
        master.add_registry(Box::new(IntegrationMockRegistry::new(RegistryType::Chromosome)));
    ...
    fn test_multi_adapter_entity_queries() {
        ...
        unified_reg.add_entity("entity-1".to_string(), EntityInfo {
        ...
        hox_reg.add_entity("entity-2".to_string(), EntityInfo {
    ...
    fn test_registry_health_status_propagation() {
        ...
        healthy_reg.add_entity("healthy-entity".to_string(), EntityInfo {
        ...
        degraded_reg.add_entity("degraded-entity".to_string(), EntityInfo {
    ...
    fn test_synchronization_error_handling() {
        ...
        let sync_result = master.synchronize_state();
        assert!(sync_result.is_ok(), "Sync should handle uninitialized registries gracefully");
    }
    ...
    fn test_entity_last_seen_tracking() {
        ...
        reg.add_entity("tracked-entity".to_string(), EntityInfo {
