...
// so ingestion events reach MaelstromUI, SSE clients, and any real-time consumer.
...
impl InboxBroadcaster {
    ...
    pub async fn broadcast_ingestion_event(
        ...
        let _json_payload = serde_json::to_string(&event)
    ...
    pub async fn broadcast_classification(
        ...
        let _json_payload = serde_json::to_string(&result)
    ...
    pub async fn broadcast_quality_metrics(
        ...
        let _json_payload = serde_json::to_string(&metric)
    ...
    pub async fn broadcast_specialist_updates(
        ...
        for event in &distillation.events {
            ...
            let _json_payload = serde_json::to_string(&update)
    ...
    pub async fn broadcast_failure(
        ...
        let _json_payload = serde_json::to_string(&failure)
    ...
    pub async fn publish_statistics(
        ...
        let _json_payload = serde_json::to_string(&stats)
