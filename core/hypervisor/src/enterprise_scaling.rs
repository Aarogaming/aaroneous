...
impl ClusterManager {
    ...
    pub fn select_node_for_data(&self, _data_id: &str) -> Result<ClusterNode, String> {
    ...
    pub fn select_replica_nodes(&self, _data_id: &str, exclude_node: &str) -> Vec<ClusterNode> {
        let healthy = self.get_healthy_nodes();
        healthy
            .iter()
...
impl LoadBalancer {
    ...
    pub fn route_request(&self, _request_id: &str, _data_region: &str) -> Result<String, String> {
