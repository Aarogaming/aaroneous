...
| **[`crates/orchestration_plane`](file:///d:/Aaroneous/crates/orchestration_plane)** | Ring 2 | High-level system coordination, domain classification, and hypervisor daemon bindings. Funnels incoming frames to reactive reducers. |
| **[`crates/governance`](file:///d:/Aaroneous/crates/governance)** | Ring 2 | Hardware thermal monitoring, Z3 SMT non-interference solvers, execution budget safety interlocks, and SI lattice constraint enforcement. |
...
| **[`crates/mutation_engine`](file:///d:/Aaroneous/crates/mutation_engine)** | Ring 2 | Safe AST transformation, layout normalization, and unwrap/panic elimination engines. |
| **[`crates/runtime_monitor`](file:///d:/Aaroneous/crates/runtime_monitor)** | Ring 2 | Telemetry inspection, thread liveness monitoring, and watchdog supervision. |
| **[`crates/capabilities`](file:///d:/Aaroneous/crates/capabilities)** | Ring 3 | Universal capability registry implementing the `UniversalTool` trait (dual JSON schema for MCP and $\mathbb{R}^{256}$ latent tensor execution for `.si` models). Codebase auditing, security screening, and tool dispatch. |
...
| **[`crates/adaptation_engine`](file:///d:/Aaroneous/crates/adaptation_engine)** | Ring 3 | Polyglot AST analysis, shadow execution sandboxes, and FFI component synthesis. |
...
| **[`crates/mcp_server`](file:///d:/Aaroneous/crates/mcp_server)** | Ring 3 | Model Context Protocol server exposing Aaroneous capabilities to external tools (Claude, Cursor, OpenCode). |
...
| **[`crates/biology`](file:///d:/Aaroneous/crates/biology)** | Ring 3 | Bio-inspired state machines, cellular automata substrates, and metabolic state decay simulations. |
