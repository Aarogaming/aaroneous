        ...
        .show_inside(ui, |ui| {
            ...
            ui.columns(2, |cols| {
                ...
                cols[0].vertical(|ui| {
                    ui.horizontal(|ui| {
                        ui.label(
                            egui::RichText::new("🤖 Active Automation Companions")
                                .strong()
                                .color(theme.accent()),
                        );
                        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                ...
                cols[1].vertical(|ui| {
                    ui.label(
                        egui::RichText::new("⚡ Fast Controls & System Telemetry")
                            .strong()
                            .color(theme.accent()),
                    );
                    ui.add_space(4.0);
                            ...
                            ui.horizontal(|ui| {
                                ...
                                ui.add(
                                    egui::ProgressBar::new(state.bus_integrity / 100.0)
                                        .text(format!("{:.0}%", state.bus_integrity)),
                                );
                            });
                            ui.horizontal(|ui| {
                                ...
                                ui.label(
                                    egui::RichText::new(format!(
                                        "⭐ Lv. {} ({} XP)",
                                        state.user_level, state.user_xp
                                    ))
                    ...
                    egui::ScrollArea::vertical()
                        ...
                        .show(ui, |ui| {
                            if state.event_logs.is_empty() {
                                ui.label(
                                    egui::RichText::new("No recent logs.")
                                        .italics()
                                        .color(Color32::GRAY),
                                );
                            } else {
