...
use hypervisor::metadata_ingestor::{
...
use orchestrator::{IntelligenceEngine, LLMConfig, ProviderType, Specialist, TaskType};
...
impl OrchestrationDaemon {
    ...
    pub fn process_assimilation_frame(
        ...
        ipc_bus::universal_protocol::UniversalServerBroadcast,
...
mod tests {
    ...
    fn test_convert_event_to_task() {
        ...
        let analysis = hypervisor::metadata_ingestor::MetadataAnalysis::default();
    ...
    fn test_convert_event_priority_high_complexity() {
        ...
        let mut analysis = hypervisor::metadata_ingestor::MetadataAnalysis::default();
