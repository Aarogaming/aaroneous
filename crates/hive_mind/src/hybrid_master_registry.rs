...
impl MasterRegistry {
    ...
    pub fn synchronize_state(&mut self) -> Result<(), String> {
        ...
        // Second pass: list entities from all adapters
        ...
        info!(
            "Master registry synchronized {} total entities",
            self.synced_entities.len()
        );
        Ok(())
    }
    ...
    pub fn add_synced_entity(&mut self, entity: EntityInfo) {
        debug!(
            "Added synced entity: {} (type: {:?})",
            entity.id, entity.health
        );
        self.synced_entities.insert(entity.id.clone(), entity);
    }
    ...
    pub fn list_all_entities(&self) -> Vec<String> {
        let ids = Vec::new();
        for _registry in &self.sub_registries {
...
impl Default for RegistryCompositionStrategy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl RegistryCompositionStrategy {
    ...
    pub fn with_unified_registry(
        mut self,
        registry: hypervisor::unified_registry::Registry<String>,
    ) -> Self {
    ...
    pub fn with_federation_model_registry(
        mut self,
        registry: crate::federation::model_registry::FederationModelRegistry,
    ) -> Self {
    ...
    pub fn with_llm_model_registry(
        mut self,
        registry: llm_gateway::model_registry::ModelRegistry,
    ) -> Self {
    ...
    pub fn with_component_registry(
        mut self,
        registry: crate::federation::component_registry::ComponentRegistry,
    ) -> Self {
    ...
    pub fn with_specialist_registry(
        mut self,
        registry: crate::federation::specialist::SpecialistRegistry,
    ) -> Self {
    ...
    pub fn with_chromosome_registry(
        mut self,
        registry: hypervisor::chromosome_registry::ChromosomeRegistry,
    ) -> Self {
    ...
    pub fn with_hox_registry(mut self, registry: hypervisor::hox_registry::HoxRegistry) -> Self {
        let adapter = crate::registry_adapters::HoxCapabilityRegistryAdapter::new(registry);
        self.adapters.push(Box::new(adapter));
        self
    }

    pub fn with_distributed_registry(
        mut self,
    ...
    pub fn build_master_registry(self, _ctx: &WorkspaceContext) -> MasterRegistry {
...
impl Default for AsyncMasterRegistry {
    fn default() -> Self {
        Self::new()
    }
}
