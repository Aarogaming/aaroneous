...
use orchestrator::{IntelligenceEngine, RoutableTask, RoutingDecision, TaskType};
...
impl AutonomousDecisionEngine {
    ...
    pub async fn process_assimilation_cycle(
        ...
        use ipc_bus::universal_protocol::{FixedString64, FixedString256};
...
mod tests {
    use super::*;
    use orchestrator::{LLMConfig, ProviderType, Specialist};
