...
impl ElectionTimeout {
    ...
    pub fn new_fixed(timeout_ms: u64) -> Self {
        Self {
...
pub fn check_election_won(votes_received: u32, votes_needed: u32) -> bool {
...
mod tests {
    ...
    fn test_election_timeout_reset() {
        let mut timeout = ElectionTimeout::new_fixed(200);
