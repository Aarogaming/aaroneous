...
pub struct McpService {
    ...
    pub universal_tools: Arc<capabilities::ToolRegistry>,
...
impl McpService {
    pub fn new(config: ServiceConfig) -> Self {
        ...
        let universal_tools = Arc::new(capabilities::build_standard_tool_registry());
    ...
    async fn execute_tool(
        ...
        let config = LLMConfig {
            provider_type: llm_gateway::ProviderType::Mock,
            ..Default::default()
        };
                ...
                "push" => {
                    ...
                    for entry_json in entries {
                        ...
                        if let Ok(entry) = serde_json::from_value::<
                            hypervisor::specialist_memory::MemoryEntry,
                        >(entry_json.clone())
                        {
