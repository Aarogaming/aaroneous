...
/// use hive_mind::federation::http::HttpStatusServer;
...
/// fed.start_all().await?;
///
/// let server = HttpStatusServer::spawn("127.0.0.1:8080".parse()?, fed.clone(), hive_mind::federation::http::router::HttpServiceConfig::default()).await?;
