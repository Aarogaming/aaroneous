...
/// use hive_mind::federation::hive::{Federation, FederationConfig};
...
pub struct Federation {
    ...
    pub nats: Arc<hypervisor::nats_client::NatsPublisher>,
    ...
    pub resources: Arc<RwLock<governance::SystemHealthGovernor>>,
}
...
impl Federation {
    ...
    pub fn builder(pm: hypervisor::persistence::PersistenceManager) -> FederationBuilder {
    ...
    pub fn circuit_breakers(
        &self,
    ) -> Vec<(String, hypervisor::resilience::CircuitBreakerCounters)> {
        Vec::new()
    }
    ...
    ///
    /// ```no_run
    /// # async fn example(fed: &hive_mind::federation::hive::Federation) {
    /// use hive_mind::federation::specialists::GenericSpecialist;
    ///
    ...
    /// ```no_run
    /// # async fn example() -> Result<(), Box<dyn std::error::Error>> {
    /// use hive_mind::federation::hive::Federation;
    /// use hypervisor::persistence::PersistenceManager;
    ///
    /// let pm = PersistenceManager::new("hive.db")?;
...
impl Federation {
    pub(crate) fn from_parts(
        ...
        let nats_config = hypervisor::nats_client::NatsClientConfig::default();
        let nats = Arc::new(hypervisor::nats_client::NatsPublisher::new(
        ...
        Self {
            ...
            resources: Arc::new(RwLock::new(governance::SystemHealthGovernor::new())),
        }
    }
}
...
impl Federation {
    ...
    async fn orchestrator_decompose_intent(&self) {
        ...
        let sab_dir = hypervisor::workspace::WorkspacePaths::workspace_root().join("sabs");
