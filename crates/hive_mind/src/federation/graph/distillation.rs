...
fn synthetic_intents_for(spec: &SovereignTaskSpec, capability_id: &str, count: u32) -> Vec<String> {
    ...
    let bank: Vec<String> = match spec.sovereign_name.to_lowercase().as_str() {
        ...
        "orchestrator" => vec![
            ...
            "Archive this session's results to the ArtifactRegistry and generate insights".into(),
        ...
        "fabricator" => vec![
            ...
            "Design the maintenance schedule for the ArtifactRegistry archival system".into(),
