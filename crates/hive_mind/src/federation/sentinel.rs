...
pub struct Sentinel {
    ...
    pub event_log: Option<std::sync::Arc<hypervisor::event_log::EventLog>>,
}
...
impl Sentinel {
    ...
    pub fn with_event_log(mut self, log: std::sync::Arc<hypervisor::event_log::EventLog>) -> Self {
    ...
    pub async fn arbitrate(&self) -> Result<ArbitrationResult, SpecialistError> {
        ...
        // Detect conflicts
        let conflicts = proposal_set.detect_conflicts();
    ...
    async fn issue_decision(&self, decision: Decision) -> Result<(), SpecialistError> {
        ...
        if let Some(log) = &self.event_log {
            use hypervisor::event_log::types::FederationEvent;
            ...
            let event = FederationEvent {
                ...
                operation: format!("decision:{}", decision.action),
                payload,
