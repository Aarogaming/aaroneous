...
pub struct Symbiotic {
    ...
    pub biometric_provider: Option<Arc<dyn BiometricProvider>>,
...
impl Symbiotic {
    ...
    pub fn attach_biometrics(&mut self, provider: Arc<dyn BiometricProvider>) {
    ...
    pub async fn scan_wearables(
        ...
        let provider: &Arc<dyn BiometricProvider> = provider;
    ...
    pub async fn register_wearable(
        ...
        let provider: &Arc<dyn BiometricProvider> = provider;
        provider.connect_by_id(device_id).await?;
        self.wearable_map
    ...
    pub fn ingest_sample(&mut self, sample: BiometricSample) {
        ...
        match sample.kind {
            ...
            BiometricKind::SkinConductance
            | BiometricKind::Temperature
            | BiometricKind::Motion
...
mod tests {
    ...
    async fn test_pending_samples_increase_confidence_slightly() {
        ...
        for i in 0..5u16 {
            let s = BiometricSample::heart_rate("dev".to_string(), (70 + i) as u32);
