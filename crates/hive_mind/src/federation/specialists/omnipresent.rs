...
impl Omnipresent {
    ...
    pub async fn with_p2p(mut self) -> Result<Self, crate::federation::p2p::P2pError> {
        let node = P2pNode::spawn(P2pNodeId::new("omnipresent-primary")).await?;
    ...
    pub async fn sync_to_device(
        ...
        let Some(_endpoint) = self.device_endpoints.get(device_id) else {
...
mod tests {
    ...
    async fn test_register_device_with_endpoint() {
        ...
        let endpoint = P2pNodeId::new("test");
