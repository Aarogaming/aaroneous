...
impl BatchReport {
    ...
    pub fn success_rate(&self) -> f64 {
        ...
        let compliant = self.per_crate_status.values().filter(|s| s.compliant).count();
...
impl Default for BatchNormalizationRunner {
    fn default() -> Self {
        Self {}
    }
}
...
mod tests {
    ...
    fn test_batch_report_success_rate() {
        ...
        for i in 0..8 {
            report.per_crate_status.insert(format!("crate_{}", i), CrateStatus {
