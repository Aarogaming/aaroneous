/// Lock-free ringbuffer for O3DE → WASM event passing
/// 
/// Single producer (O3DE), single consumer (WASM)
...
pub struct RingBuffer {
    ...
    /// Write pointer (O3DE writes here)
...
impl RingBuffer {
    ...
    /// Push event (non-blocking, from O3DE)
