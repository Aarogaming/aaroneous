...
impl Default for IngestionConfig {
    fn default() -> Self {
        Self {
            inbox_path: PathBuf::from("D:\\Aaroneous\\data\\inbox"),
            processing_path: PathBuf::from("D:\\Aaroneous\\data\\processing"),
            processed_path: PathBuf::from("D:\\Aaroneous\\data\\processed"),
            failed_path: PathBuf::from("D:\\Aaroneous\\data\\failed"),
            analytics_path: PathBuf::from("D:\\Aaroneous\\data\\analytics"),
