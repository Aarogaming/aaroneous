...
impl GeneticLocus {
    pub fn new(id: String, category: GeneticCategory, value: f64, source: LociSource) -> Self {
        assert!(value >= 0.0 && value <= 1.0, "Genetic value must be in [0.0, 1.0]");
        Self {
            locus_id: id,
            category,
            value,
...
impl SpecialistGenome {
    ...
    pub fn expressed_trait_value(&self, locus: &GeneticLocus) -> f64 {
        ...
        (base_value * methylation_effect * modification_effect * accessibility_factor).clamp(0.0, 1.0)
    }
...
impl BreedingOperation {
    ...
    pub fn simple_crossover(
        ...
        let mut offspring = SpecialistGenome::new(
            ...
            format!("hybrid_of_{}_and_{}", parent1.base_model, parent2.base_model),
        );
        ...
        offspring.genetic_distance_to_base = (parent1.genetic_distance_to_base
            + parent2.genetic_distance_to_base)
            / 2.0;
    ...
    pub fn weighted_blend(
        ...
        assert!((weight1 + weight2 - 1.0).abs() < 0.01, "Weights must sum to 1.0");
        ...
        for parent1_locus in &parent1.genetic_loci {
            ...
            {
                let blended_value =
                    parent1_locus.value * weight1 + parent2_locus.value * weight2;
                ...
                blended_locus.confidence = (parent1_locus.confidence + parent2_locus.confidence) / 2.0;
...
impl GeneticAnalyzer {
    ...
    pub fn find_breeding_candidates<'a>(
        ...
        candidates.sort_by(|a, b| {
            let score_a =
                Self::trait_match_score(a.0, desired_traits) + Self::trait_match_score(a.1, desired_traits);
            let score_b =
                Self::trait_match_score(b.0, desired_traits) + Self::trait_match_score(b.1, desired_traits);
...
mod tests {
    ...
    fn test_simple_crossover() {
        let mut parent1 = SpecialistGenome::new("p1".to_string(), "Parent1".to_string(), "model1".to_string());
        let mut parent2 = SpecialistGenome::new("p2".to_string(), "Parent2".to_string(), "model2".to_string());
        ...
        let offspring = BreedingOperation::simple_crossover(&parent1, &parent2, "offspring".to_string());
    ...
    fn test_genetic_distance() {
        let mut genome1 = SpecialistGenome::new("g1".to_string(), "Specialist1".to_string(), "model".to_string());
        let mut genome2 = SpecialistGenome::new("g2".to_string(), "Specialist2".to_string(), "model".to_string());
