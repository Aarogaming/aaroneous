...
| `0x0200 - 0x02FF` | **Sensory & Reflex (Marionette)**| 128x128 sensory grid, motor intents, SpatialDelta gate mask. | `128x128 f32` grid / `MotorIntent` |
...
Offset 0x10100├─────────────────────────────────────────────────────────┤
              │ SpatialDelta Gate Matrix (256 sectors, boolean / u8 mask) │
Offset 0x10200├─────────────────────────────────────────────────────────┤
