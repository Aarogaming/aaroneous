...
impl ExperimentResult {
    ...
    fn run_unit_test(hypothesis: &Hypothesis, workspace_root: &str) -> Self {
        ...
        let output = Command::new("cargo")
            .args(&["test", "--manifest-path", &format!("{}/Cargo.toml", workspace_root)])
            .output();
    ...
    fn run_benchmark(hypothesis: &Hypothesis, workspace_root: &str) -> Self {
        ...
        let outcome = if success_count == design.iterations {
            ...
            TestOutcome::Fail(format!("{}/{} iterations failed", design.iterations - success_count, design.iterations))
        } else {
        ...
        Self {
            ...
            outcome,
            execution_time_ms: execution_time,
            stdout: format!("Completed {}/{} iterations", success_count, design.iterations),
            stderr: String::new(),
            exit_code: None,
