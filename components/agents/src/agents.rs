...
impl Default for SpecialistAgent {
    fn default() -> Self {
        ...
        SpecialistAgent {
            ...
            hox_preset_path: paths.registry().join("hox_specialist_template.json").to_string_lossy().to_string(),
            enzyme_subset: vec![],
            interval_ms: 30000,
...
impl Default for RelicAgent {
    fn default() -> Self {
        ...
        RelicAgent {
            ...
            cognitive_bias: CognitiveBias::default(),
            hox_preset_path: paths.registry().join("hox_relic_template.json").to_string_lossy().to_string(),
            enzyme_subset: vec![],
            interval_ms: 30000,
...
pub fn create_specialist(name: &str) -> Option<SpecialistAgent> {
    ...
    match name.to_lowercase().as_str() {
        "ariel" => Some(SpecialistAgent {
            ...
            hox_preset_path: paths.sovereign_hox_preset("ariel").to_string_lossy().to_string(),
            ...
            model_hash: "70fe5af18c8f804a2e071fed22f72327f7beb59acdb905a476acbd40cb5513ee".to_string(),
        ...
        "merlin" => Some(SpecialistAgent {
            ...
            hox_preset_path: paths.sovereign_hox_preset("merlin").to_string_lossy().to_string(),
            enzyme_subset: vec!["thought_kernel".to_string(), "tensor_forge".to_string()],
            interval_ms: 25000,
            model_path: paths.sovereign_model("merlin").to_string_lossy().to_string(),
            model_hash: "b75872377e2b5fe391b4c168d1184c6be24ea362de63f788875c6493eccb55e2".to_string(),
            status: "active".to_string(),
        }),
        "odin" => Some(SpecialistAgent {
            ...
            hox_preset_path: paths.sovereign_hox_preset("odin").to_string_lossy().to_string(),
            ...
            model_hash: "ec614427643249d67a927ad5ad5b19e71d56eb3f3ec4d63c58ff0a5f2b17033c".to_string(),
            status: "active".to_string(),
        }),
        "dionysus" => Some(SpecialistAgent {
            ...
            hox_preset_path: paths.sovereign_hox_preset("dionysus").to_string_lossy().to_string(),
            enzyme_subset: vec!["sensor_node".to_string(), "thought_kernel".to_string()],
            interval_ms: 35000,
            model_path: paths.sovereign_model("dionysus").to_string_lossy().to_string(),
            model_hash: "4cdca60ca840f3de4f4a4b12649ac05136f2637971f729b1075639492834e3d2".to_string(),
            status: "active".to_string(),
        }),
        "hephaestus" => Some(SpecialistAgent {
            ...
            hox_preset_path: paths.sovereign_hox_preset("hephaestus").to_string_lossy().to_string(),
            enzyme_subset: vec!["tensor_forge".to_string(), "thought_kernel".to_string()],
            interval_ms: 22000,
            model_path: paths.sovereign_model("hephaestus").to_string_lossy().to_string(),
        ...
        "argus" => Some(SpecialistAgent {
            ...
            hox_preset_path: paths.sovereign_hox_preset("argus").to_string_lossy().to_string(),
...
pub fn create_relic(name: &str, supervisor_id: &str) -> Option<RelicAgent> {
    ...
    match name.to_lowercase().as_str() {
        "glass" => Some(RelicAgent {
            ...
            hox_preset_path: paths.relic_hox_preset("glass").to_string_lossy().to_string(),
            enzyme_subset: vec!["sensor_node".to_string(), "tensor_forge".to_string()],
            interval_ms: 18000,
            metadata: HashMap::new(),
        ...
        "grimoire" => Some(RelicAgent {
            ...
            hox_preset_path: paths.relic_hox_preset("grimoire").to_string_lossy().to_string(),
            enzyme_subset: vec!["thought_kernel".to_string(), "tensor_forge".to_string()],
            interval_ms: 28000,
            metadata: HashMap::new(),
            model_path: paths.sovereign_model("grimoire").to_string_lossy().to_string(),
            model_hash: "b75872377e2b5fe391b4c168d1184c6be24ea362de63f788875c6493eccb55e2".to_string(),
            status: "active".to_string(),
        }),
        "draupnir" => Some(RelicAgent {
            ...
            hox_preset_path: paths.relic_hox_preset("draupnir").to_string_lossy().to_string(),
            enzyme_subset: vec!["thought_kernel".to_string(), "nat_bridge".to_string()],
            interval_ms: 32000,
            metadata: HashMap::new(),
            model_path: paths.sovereign_model("draupnir").to_string_lossy().to_string(),
            model_hash: "ec614427643249d67a927ad5ad5b19e71d56eb3f3ec4d63c58ff0a5f2b17033c".to_string(),
            status: "active".to_string(),
        }),
        ...
        "forge" => Some(RelicAgent {
            ...
            hox_preset_path: paths.relic_hox_preset("forge").to_string_lossy().to_string(),
            enzyme_subset: vec!["tensor_forge".to_string(), "thought_kernel".to_string()],
            interval_ms: 20000,
            metadata: HashMap::new(),
        ...
        "sentinel" => Some(RelicAgent {
            ...
            hox_preset_path: paths.relic_hox_preset("sentinel").to_string_lossy().to_string(),
            enzyme_subset: vec!["nat_bridge".to_string(), "sensor_node".to_string()],
            interval_ms: 12000,
            metadata: HashMap::new(),
